...
public class clientTest
{
	...
	case 23: // start a transaction
	    ...
	    System.out.println("Starting transaction using id: " + arguments.elementAt(1));
	    try{
	    Id = obj.getInt(arguments.elementAt(1));
	    rm.start(Id);
	...
	case 24: // commit a transaction
	    ...
	    break;
 	    ...
 	    System.out.println("Committing transaction using id: " + arguments.elementAt(1));
	    try{
	    Id = obj.getInt(arguments.elementAt(1));
	    rm.commit(Id);
	    System.out.println("Committed transaction " + Id);
	    }
	    catch(Exception e){
	    System.out.println("EXCEPTION:");
	    System.out.println(e.getMessage());
	...
	case 25: // abort a transaction
	    ...
	    System.out.println("Aborting transaction using id: " + arguments.elementAt(1));
	    try{
	    Id = obj.getInt(arguments.elementAt(1));
	    rm.abort(Id);
	...
	case 23: // start a transaction with id
	System.out.println("Start a transaction with an id");
	System.out.println("\nUsage:");
	System.out.println("\tstart,<id>");
	break;

	case 24: // commit a transaction with id
	System.out.println("Commit a transaction with an id");
	System.out.println("\nUsage:");
	System.out.println("\tcommit,<id>");
	break;

	case 25: // abort a transactionusing id
	System.out.println("Abort a transaction with an id");
	System.out.println("\nUsage:");
